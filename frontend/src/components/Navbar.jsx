          ...
          <div className="flex items-center gap-6">
            ...
            {user ? (
              <div className="flex items-center gap-4">
                ...
                <Link to="/account" className="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold shadow-md hover:scale-105 transition-transform">
